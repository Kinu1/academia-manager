...
const errorMessages: Record<string, string> = {
  ...
  email_conflict: 'Este e-mail já está cadastrado.',
  data_conflict: 'Estes dados já existem ou entram em conflito.',
...
export function toApiError(error: unknown): ApiError {
  ...
  return new ApiError('Não foi possível concluir a operação.', 'unknown_error')
}
