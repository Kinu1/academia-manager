  ...
  return (
    <div className="space-y-6">
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <MetricCard icon={Users} label="Alunos" value={students.data} isLoading={students.isLoading} />
        <MetricCard icon={Dumbbell} label="Planos" value={plans.data} isLoading={plans.isLoading} />
        <MetricCard icon={Route} label="Treinos" value={trainings.data} isLoading={trainings.isLoading} />
        <MetricCard icon={Receipt} label="Pagamentos" value={payments.data} isLoading={payments.isLoading} />
      </section>
